...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/msp?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
